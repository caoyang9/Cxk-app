...
public class JustBecauseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_justbecause);
    ...
    private void initializeMediaPlayer() {
        try {
            // 创建MediaPlayer实例
            mediaPlayer = MediaPlayer.create(this, R.raw.justbecause);
            ...
            mediaPlayer.setOnCompletionListener(mp -> {
                if (isLooping) {
                    // 如果是循环模式，重新开始播放
                    mediaPlayer.start();
                    Toast.makeText(JustBecauseActivity.this, "循环播放中...", Toast.LENGTH_SHORT).show();
                }
            });
